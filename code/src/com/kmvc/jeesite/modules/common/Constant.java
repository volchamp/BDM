...
public class Constant
{
    ...
    public static final int WS_FLAG_SUCCEED = 0;
    public static final int WS_FLAG_MSGID_NOT_NULL = 1;
    public static final int WS_FLAG_PAGE_SIZE_NOT_RIGHT = 2;
    public static final int WS_FLAG_TOTAL_PAGE_NOT_RIGHT = 3;
    public static final int WS_FLAG_CURRENT_PAGE_NOT_RIGHT = 4;
    public static final int WS_FLAG_CODE_SET_NO_NOT_RIGHT = 5;
    public static final int WS_FLAG_CODE_SET_NAME_NOT_RIGHT = 6;
    public static final int WS_FLAG_REGION_CODE_NOT_RIGHT = 7;
    public static final int WS_FLAG_REGION_NAME_NOT_RIGHT = 8;
    public static final int WS_FLAG_SOUR_SYS_CODE_NOT_RIGHT = 9;
    public static final int WS_FLAG_SOUR_SYS_NAME_NOT_RIGHT = 10;
    public static final int WS_FLAG_CODE_EN_COLL_NOT_RIGHT = 11;
    public static final int WS_FLAG_PAGE_HANDLED = 12;
    public static final int WS_FLAG_JSON_WRONG_TO_BEAN = 13;
    public static final int WS_FLAG_DIFF_BATCH_MSGID_UNIQ = 14;
    public static final int WS_FLAG_MDM_FIND_CODESET_ERR = 15;
    public static final int WS_FLAG_INOBJ_ATTRVAL_ERR = 16;
    public static final int WS_FLAG_MDM_NOTEXIST_BIZSYS = 17;
    public static final int WS_FLAG_MDM_FIND_CODESETDATA_ERR = 18;
    public static final int WS_FLAG_BIZ_FIND_CODESETDATA_ERR = 19;
    public static final int WS_FLAG_BIZ_PROC_CODESET_ERR = 20;
    ...
    public static final int CODESET_DATA_OPERATION_ADD = 0;
    public static final int CODESET_DATA_OPERATION_MOD = 1;
    public static final int CODESET_DATA_OPERATION_DEL = 2;
    public static final int CODESET_DATA_OPERATION_MODDIST = 4;
    public static final int CODESET_DATA_OPERATION_NORMAL = -1;
    public static final int CODESET_OPERATION_ADD = 0;
    public static final int CODESET_OPERATION_MOD = 1;
    public static final int CODESET_OPERATION_DEL = 2;
    public static final int CODESET_OPERATION_MODDATA = 4;
    public static final int CODESET_OPERATION_NORMAL = 10;
    public static final int CODESET_PROCESS_STATUS_NORMAL = 10;
    ...
    public static final String LOGINNAME_SUPER_ADMIN = "thinkgem";
    public static final Integer CORE_FLAG_TRUE;
    public static final Integer CORE_FLAG_FALSE;
