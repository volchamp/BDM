...
<a href="#" class="layui-btn layui-btn-xs layui-btn-normal" style="float: left;" onclick="window.location.reload();">刷新</a>
	<!-- 新建页面 -->
		...
		<!-- 我的任务 -->
			<div class="layui-card">
				<div class="layui-card-header">
					...
					我的任务
					<a class="amore" jurl="${ctx}/tesk/task/?taskStatus=0" id="amore1" tabName="待办任务" href="javascript:void(0)" >更多>></a>
				</div>
				<div class="layui-card-body">
						...
						<table id="contentTable" class="table table-striped table-bordered table-condensed">
							...
							<c:if test="${fn:length(pageToDoTask.list) == 0}">
								<tr>
			...
			<div class="layui-card">
				<div class="layui-card-header">
					...
					<a class="amore" jurl="${ctx}/tesk/task/?taskStatus=1" id="amore/mdm/a/tesk/task/?taskStatus=0" tabName="已办任务" href="javascript:void(0)"   >更多>></a>
				</div>
				<div class="layui-card-body">
						<sys:message content="${message}"/>
						<table id="contentTable" class="table table-striped table-bordered table-condensed">
							...
							<c:if test="${fn:length(pageDoneTask.list) == 0}">
								<tr>
			...
			<div class="layui-card n1112_5card n1112_5card1">
				<div class="layui-card-header">
					...
					<a class="amore" jurl="${ctx}/codesetstatistics/statistics" id="amore3" tabName="代码集统计分析" href="javascript:void(0)">更多>></a>
			...
			<div class="layui-card n1112_5card">
					<div class="layui-card-header">
						<div class="n1112_cardicon"></div>
						代码集统计
						<a class="amore" jurl="${ctx}/codesetstatistics/statistics" id="amore4" tabName="代码集统计分析" href="javascript:void(0)">更多>></a>
						<div class="ct_clear"></div>
					</div>
					<div class="layui-card-body n1112_cardBody">
			...
			<div class="layui-card">
					<div class="layui-card-header">
						<div class="n1112_cardicon"></div>
						接口收发日志
						<a class="amore" jurl="${ctx}/inoutlog/logInout/" id="amore5" tabName="收发日志管理" href="javascript:void(0)">更多>></a>
					</div>
					<div class="layui-card-body">
							<sys:message content="${message}"/>
							<table id="contentTable" class="table table-striped table-bordered table-condensed">
								...
								<c:forEach items="${pageLogInout.list}" var="logInout">
									<tr>
										...
										<td>
													${fn:length(logInout.areaName) == 0 ? '云南省' :  logInout.areaName}
										</td>
										<td>
								...
								<c:if test="${fn:length(pageLogInout.list) == 0}">
									<tr>
		...
		$(document).ready(function(){
			...
			layui.use('element', function(){
				...
				$("#n1112_nbox").on('click','.amore',function(){
					...
					// alert("layId_listLen = " + layId_listLen + ", id = " + id);
